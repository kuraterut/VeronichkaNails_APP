...
public class Help{
    public static void main(String[] args) {
        try{
            ...
            PreparedStatement pstmt = database.connection.prepareStatement("INSERT INTO GALERY (Image_NAME, Image_FILE) VALUES (?, ?)");
            FileInputStream fis = new FileInputStream(new File("photos/1.jpg"));
            pstmt.setString(1, "13.jpg");
            pstmt.setBinaryStream(2, fis, (int) new File("photos/1.jpg").length());
            pstmt.executeUpdate();
        }
        catch(Exception ex){
